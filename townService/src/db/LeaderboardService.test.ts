...
const testLeaderboard : ScoreModel[] = [
  testScoreModel, testScoreModel2, testScoreModelBest
]
...
describe('LeaderboardService', () => {
  ...
  describe('InsertScore', () =>  {
    ...
    it('throws an error when addScore is undefined', async () => {
      ...
      await expect(async () => {await insertScore(testScoreModel)}).rejects.toThrowError()
    })
  })
  ...
  describe('getLeaders', () => {
    ...
    it('throws an error when getScores returns undefined', async () => {
      ...
      await expect(async () => {await getLeaders(5)}).rejects.toThrowError()
    })
    ...
    it('throws an error when a value less than 1 is inputed', async () => {
      ...
      await expect(async () => {await getLeaders(0)}).rejects.toThrowError()
    })
    it('throws an error when a value greater than 10 is inputed', async () => {
      getScoresFunc.mockImplementation(() => "response")
      await expect(async () => {await getLeaders(11)}).rejects.toThrowError()
    })
  })
  ...
  describe('removeFromLeaderboard', () => {
    ...
    it('throws an error when removeScore returns undefined', async () => {
      ...
      await expect(async () => {await removeScoreFromLeaderboard('test')}).rejects.toThrowError()
    })
  ...
  describe('findScoreByID', () => {
    ...
    it('throws an error when removeScore returns undefined', async () => {
      ...
      await expect(async () => {await findScoreByID('test')}).rejects.toThrowError()
    })
    it('throws an error when removeScore returns null', async () => {
  ...
  describe('updateScoreValue', () => {
    ...
    it('throws an error when updateScore returns undefined', async () => {
      ...
      await expect(async () => {await updateScoreValue(testScoreModel2)}).rejects.toThrowError()
    })
